import { ArrivingBus, ArrivingBuses, BusStation, StationOfTargetBus } from "@/types";
...
export const fetchDestinationInfoOfTargetBus = async (targetBus: ArrivingBus, station: StationOfTargetBus): Promise<any> => {
